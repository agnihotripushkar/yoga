...
class AuthController(
    ...
    /**
     * Google OAuth login endpoint Validates Google ID token and returns JWT tokens
     *
    ...
    /**
     * Apple OAuth login endpoint Validates Apple ID token and returns JWT tokens
     *
    ...
    /**
     * Token refresh endpoint Validates refresh token and returns new JWT tokens
     *
    ...
    /**
     * Get user profile endpoint Returns user profile information for authenticated users
     *
    ...
    fun getUserProfile(
        ...
        return try {
            ...
            val userId =
                    jwtTokenManager.getUserIdFromToken(token)
            ...
            // Get user profile
            val userProfile =
                    userService.getUserProfile(userId).orElseThrow {
